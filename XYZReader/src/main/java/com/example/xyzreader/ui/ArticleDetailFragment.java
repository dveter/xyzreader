...
public class ArticleDetailFragment extends Fragment implements
    ...
    private HashMap statusbarColorsMap = new HashMap();
  ...
  //      mPhotoContainerView = mRootView.findViewById(R.id.photo_container);
    ...
    private void updateStatusBar() {
      /*  int color = 0;
       ...
       // mDrawInsetsFrameLayout.setInsetBackground(mStatusBarColorDrawable);
        ...
        if (tmpActivity != null) {
            int colorFrom = tmpActivity.getWindow().getStatusBarColor();
            ...
            colorAnimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animator) {
                    tmpActivity.getWindow().setStatusBarColor((int) animator.getAnimatedValue());
                }
    ...
    // Method to resice toolbar -> to pevent statusbar overlaping dinamically sized titlebar

    private void resizeToolbar() {
        final ViewTreeObserver observer= metaBar.getViewTreeObserver();
        observer.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            @Override
            public void onGlobalLayout() {
                CollapsingToolbarLayout.LayoutParams layoutParams = (CollapsingToolbarLayout.LayoutParams) toolbar.getLayoutParams();
                layoutParams.height = metaBar.getHeight();
